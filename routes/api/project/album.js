...
let AlbumSchema = require('../../../models/project/album');
...
router.route('/get-photo-count').post((req, res) =>{
    ...
    var photo_dir = 'uploads/project/'+ department_name +'/album/'+albumname+'/photos';
...
router.post('/create-album-photos',multer({ dest: 'uploads' }).any(), async (req,res) => {
    ...
    if(req.files)
    {
        ...
        var albumname = req.body.album_id;
        var department_name = req.body.department;
        var new_folder = 'uploads/project/'+ department_name +'/album/'+albumname+'/photos';
            ...
            if (err) {
              ...
              req.files.map((f) => {
                ...
                fs.readFile(old_path, (err, data) => {
                  ...
                  var new_path = 'uploads/project/'+ department_name +'/album/'+albumname+'/photos/'+photo_id+".jpg";
